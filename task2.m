...
% [med_height_comp_front, med_width_comp_front] = tam_med(mask_comp_front);
% [med_height_comp_back, med_width_comp_back] = tam_med(mask_comp_back);
% [med_height_comp_side, med_width_comp_side] = tam_med(mask_comp_side);
...
% [med_height_sed_front, med_width_sed_front] = tam_med(mask_sed_front);
% [med_height_sed_back, med_width_sed_back] = tam_med(mask_sed_back);
% [med_height_sed_side, med_width_sed_side] = tam_med(mask_sed_side);
% [med_height_sed_other, med_width_sed_other] = tam_med(mask_sed_other);
...
% [med_height_suv_front, med_width_suv_front] = tam_med(mask_suv_front);
% [med_height_suv_back, med_width_suv_back] = tam_med(mask_suv_back);
% [med_height_suv_side, med_width_suv_side] = tam_med(mask_suv_side);
% [med_height_suv_other, med_width_suv_other] = tam_med(mask_suv_other);
...
function [height, width] = tam_med(imgs)
...
med_bottom = bottom_tot / size(imgs,2);
med_left = left_tot / size(imgs,2);
med_right = right_tot / size(imgs,2);
